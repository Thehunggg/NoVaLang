...
- **⚠ D-11 · legacy · ja · MÂU THUẪN CHƯA GIẢI QUYẾT** — Chính sách romaji chung
  theo trình độ tồn tại **HAI bản ngược nhau**:
  - **(i)** Basic **hiện mặc định** / Intermediate ẩn có toggle / Advanced không
    hiện (trừ ngoại lệ đã duyệt).
  - **(ii)** A0–B1 **ẩn mặc định** có toggle / B2–C2 không toggle.
  Hai bản ngược nhau ở người mới (hiện vs ẩn). **Không tự quyết** — bắt buộc đưa
  vào checklist review (Bước 4) như quyết định sản phẩm; không tính vào trần 8 mục.
