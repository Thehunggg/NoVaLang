...
> **✅ CẬP NHẬT 2026-07-19: owner ĐÃ DUYỆT cả 4 mục** (D-ro-01, D-ro-02, D-ro-03
> phương án C, D-ro-04 — xem dấu ✅). `native-review-ro.md` GIỮ NGUYÊN. Status
> ngôn ngữ KHÔNG đổi (VALIDATED_NOT_YET_PROVEN, không FROZEN);
> `answer_acceptance_ro` nâng C/VALIDATED. Ghi kèm: `decisions.md` D-70.
...
> **✅ OWNER ĐÃ DUYỆT 2026-07-19: baseline ro-RO.** Chốt chính thức.
...
> **✅ OWNER ĐÃ DUYỆT 2026-07-19: chính tả â/î theo quy tắc Academia Română 1993
> (î đầu/cuối từ, â giữa từ).** Chốt chính thức.
...
> **✅ OWNER ĐÃ DUYỆT 2026-07-19: phương án C (thiếu dấu Rumani = SAI, tiền lệ pl
> D-64).** Giữ lưu ý ș/ț dùng comma-below (không cedilla).
> `answer_acceptance_ro` cập nhật hướng C + nâng VALIDATED. Nhắc cài bàn phím
> Rumani.
...
> **✅ OWNER ĐÃ DUYỆT 2026-07-19: tu/dumneavoastră (bỏ dumneata cổ).** Chốt
> chính thức.
