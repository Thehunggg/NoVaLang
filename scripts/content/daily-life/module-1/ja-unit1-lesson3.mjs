...
const PRACTICE_EXERCISES = [
  ...
  },
  {
    ...
    chat: {
      ...
      messages: [
        ...
        { id: 'message_4', speakerId: 'b', segments: [{ displayText: 'じゃあ、また来週（らいしゅう）。', canonicalText: 'じゃあ、また来週。', audioText: 'じゃあ、またらいしゅう。' }] },
        { id: 'message_5', speakerId: 'a', segments: [{ displayText: 'また来週（らいしゅう）。', canonicalText: 'また来週。', audioText: 'またらいしゅう。' }, { slotId: 'chat_farewell_slot' }, { displayText: '。' }] },
    ...
    feedback: { correctAnswer: 'こちらこそ\nお元気（げんき）で', canonicalAnswer: 'こちらこそ／お元気で', audioText: 'こちらこそ／おげんきで', correctMessage: 'Bạn làm tốt lắm!', slotFeedback: { chat_kochira_slot: { incorrectMessage: 'Ô này là câu đáp lại lời làm quen.', correctAnswer: 'こちらこそ', explanation: 'Được chào よろしくお願いします thì đáp こちらこそ.' }, chat_farewell_slot: { incorrectMessage: 'Ô này là lời chào tạm biệt.', correctAnswer: 'お元気で', explanation: 'お元気で dùng khi chia tay từ một tuần trở lên.' } } },
  },
  {
  ...
  },
  {
    ...
    dialogueLines: [
      ...
      dialogueLine('tanaka', 'はい。また来週。', 'はい。またらいしゅう。', 'Vâng. Hẹn tuần sau.', 'はい。またらいしゅう'),
      dialogueLine('sato', 'また来週。お元気で。', 'またらいしゅう。おげんきで。', 'Hẹn tuần sau. Giữ sức khỏe nhé.', 'またらいしゅう。おげんきで'),
...
const JA_UNIT1_LESSON3_SOURCE = {
  ...
  lesson: {
    ...
    content: {
      ...
      vocabularyDetails: [
        { id: 'kochira-koso', timingAndContext: ['Đáp lại khi người kia vừa bày tỏ thiện chí.'], appropriateFor: ['Người mới gặp', 'Bạn cùng lớp', 'Thầy cô'], avoid: ['Không dùng để mở đầu — đây là câu đáp.'], register: 'Lịch sự.', formal: [], casual: [], overview: 'Tôi cũng vậy / Chính tôi mới phải nói thế.', examples: [example('こちらこそ、よろしくお願いします。', 'こちらこそ、よろしくおねがいします。', 'Tôi cũng rất mong được làm quen.')] },
        { id: 'sou-desu-ka', timingAndContext: ['Tiếp nhận một thông tin vừa nghe.'], appropriateFor: ['Mọi đối tượng'], avoid: ['Không dùng khi chưa ai nói gì.', 'Không dùng để tự giới thiệu.'], register: 'Lịch sự.', formal: [], casual: [], overview: 'Vậy à. / Ra vậy.', examples: [example('そうですか。田中さんですね。', 'そうですか。たなかさんですね。', 'Ra vậy. Bạn là Tanaka nhỉ.')] },
        { id: 'watashi-mo', timingAndContext: ['Nói mình cũng như người vừa nói.'], appropriateFor: ['Mọi đối tượng'], avoid: ['Không thay bằng 私は — は không diễn đạt "cũng vậy".'], register: 'Trung tính.', formal: [], casual: [], overview: 'Tôi cũng vậy.', examples: [example('私（わたし）も。', 'わたしも。', 'Tôi cũng vậy.')] },
        { id: 'shitsurei-shimasu', timingAndContext: ['Xin phép rời đi.', 'Rời khỏi phòng hoặc kết thúc cuộc gặp.'], appropriateFor: ['Thầy cô', 'Người trên', 'Người mới quen trong hoàn cảnh trang trọng'], avoid: ['Quá trang trọng khi chỉ chia tay bạn bè ngang hàng.'], register: 'Lịch sự.', formal: [], casual: ['Cách thân mật chuẩn:', 'じゃあ、また', 'Dùng với:', 'Bạn bè', 'Không dùng với thầy cô.'], overview: 'Tôi xin phép. / Xin lỗi (khi rời đi).', examples: [example('では、失礼します。', 'では、しつれいします。', 'Vậy, tôi xin phép.')] },
        { id: 'osaki-ni-shitsurei', timingAndContext: ['Rời đi trước người khác ở một nơi chung.'], appropriateFor: ['Bạn cùng lớp', 'Đồng nghiệp', 'Thầy cô'], avoid: ['Không dùng khi không có ai ở lại.'], register: 'Lịch sự.', formal: [], casual: [], overview: 'Tôi xin phép về trước.', examples: [example('お先に失礼します。', 'おさきにしつれいします。', 'Tôi xin phép về trước.')] },
        { id: 'ogenki-de', timingAndContext: ['Chia tay khi lần gặp lại cách nhau từ một tuần trở lên.'], appropriateFor: ['Bạn cùng lớp', 'Đồng nghiệp', 'Người quen'], avoid: ['Không dùng khi mai hoặc vài ngày nữa đã gặp lại.'], register: 'Lịch sự.', formal: [], casual: [], overview: 'Giữ sức khỏe nhé (khi chia tay từ một tuần trở lên).', examples: [example('では、お元気で。', 'では、おげんきで。', 'Vậy, giữ sức khỏe nhé.')] },
        { id: 'jaa-mata', timingAndContext: ['Chia tay bạn bè, hẹn gặp lại trong thời gian gần.'], appropriateFor: ['Bạn bè', 'Người ngang hàng'], avoid: ['Không dùng với thầy cô.', 'Không dùng với người mới quen trong hoàn cảnh trang trọng.'], register: 'Thân mật.', formal: ['Cách trang trọng hơn:', '失礼します', 'Dùng với:', 'Thầy cô', 'Người trên'], casual: [], overview: 'Thôi, hẹn gặp lại (thân mật).', examples: [example('じゃあ、また明日。', 'じゃあ、またあした。', 'Thôi, hẹn mai gặp.')], notes: ['Trong tình huống thân mật, thường bỏ chủ ngữ và nói ngắn.'] },
        { id: 'raishuu', timingAndContext: ['Chỉ mốc thời gian tuần sau, thường đi với また.'], appropriateFor: ['Mọi đối tượng'], avoid: ['Không dùng khi mốc gặp lại không phải tuần sau.'], register: 'Trung tính.', formal: [], casual: [], overview: 'Tuần sau.', examples: [example('また来週。', 'またらいしゅう。', 'Hẹn tuần sau.')] },
      ],
  ...
  vocabulary: [
    ...
    { id: 'ogenki-de', displayText: 'お元気（げんき）で', reading: 'おげんきで', romanization: 'o-genki de', speechText: 'おげんきで', meaningVi: 'Giữ sức khỏe nhé (khi chia tay từ một tuần trở lên).', translationByNative: vi('Giữ sức khỏe nhé (khi chia tay từ một tuần trở lên).'), translations: vi('Giữ sức khỏe nhé (khi chia tay từ một tuần trở lên).'), audioLocale: 'ja-JP' },
