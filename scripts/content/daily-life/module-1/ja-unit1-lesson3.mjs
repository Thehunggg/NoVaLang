  ...
  lesson: {
    ...
    content: {
      ...
      vocabularyDetails: [
        ...
        { id: 'watashi-mo', timingAndContext: ['Nói mình cũng như người vừa nói.'], appropriateFor: ['Mọi đối tượng'], avoid: ['Không thay bằng 私は — は không diễn đạt "cũng vậy".'], register: 'Lịch sự.', formal: [], casual: [], overview: 'Tôi cũng vậy.', examples: [example('私（わたし）も。', 'わたしも。', 'Tôi cũng vậy.')] },
        ...
        { id: 'raishuu', timingAndContext: ['Chỉ mốc thời gian tuần sau, thường đi với また.'], appropriateFor: ['Mọi đối tượng'], avoid: ['Không dùng khi mốc gặp lại không phải tuần sau.'], register: 'Lịch sự.', formal: [], casual: [], overview: 'Tuần sau.', examples: [example('また来週。', 'またらいしゅう。', 'Hẹn tuần sau.')] },
      ],
