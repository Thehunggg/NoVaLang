...
const PRACTICE_EXERCISES = [
  ...
  },
  {
    ...
    subQuestions: [
      ...
      { id: 'q9_4', prompt: 'おかげさまで đi cùng từ nào ở đầu câu?', options: [option('hai', 'はい'), option('un', 'うん'), option('a', 'あ'), option('mou_ichido', 'もう一度')], correctOptionId: 'hai', feedback: { correctAnswer: 'はい', explanation: 'Câu đáp lịch sự là はい。おかげさまで。' } },
