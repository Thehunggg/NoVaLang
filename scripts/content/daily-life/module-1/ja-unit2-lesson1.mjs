...
const PRACTICE_EXERCISES = [
  ...
  },
  {
    ...
    scenarioDescription: 'Sau kỳ nghỉ dài, Satō gặp lại thầy ở hành lang rồi gặp lại bạn cùng lớp ở sân trường. Cùng một ý chào, hai mức lịch sự khác nhau.',
    characterIds: ['sato', 'sensei', 'tanaka'],
    dialogueLines: [
      ...
      dialogueLine('sensei', 'ではまた。', 'ではまた。', 'Thôi, hẹn gặp lại.', 'ではまた'),
      ...
      dialogueGroups: [
        {
          ...
          explanation: ['Với thầy cô dùng おはようございます, không dùng おはよう.', 'Gọi thầy là 先生, không gắn さん.', 'Mỗi lượt chỉ làm một việc: chào trước, chia tay sau — không gộp cả hai vào một hơi.'],
        },
        {
