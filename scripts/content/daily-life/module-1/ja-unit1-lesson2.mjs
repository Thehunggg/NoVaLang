...
const PRACTICE_EXERCISES = [
  ...
  },
  {
    ...
    context: 'Tanaka hỏi tên người mới gặp và được trả lời, nhưng nghe chưa rõ nên muốn nhờ nói lại.',
  ...
  },
  {
    ...
    chat: {
      timestamp: '14:00',
      context: 'Hai người mới gặp nhắn tin cho nhau: một người hỏi tên người kia, nghe xong thì nhắc lại tên cho chắc. Nhập từ phù hợp vào hai ô trống.',
...
const JA_UNIT1_LESSON2_SOURCE = {
  ...
  lesson: {
    ...
    content: {
      ...
      vocabularyDetails: [
        { id: 'namae', timingAndContext: ['Nói về tên nói chung.', 'Nói tên của chính mình.'], appropriateFor: ['Mọi đối tượng'], avoid: ['Không thêm お cho tên của chính mình.'], register: 'Lịch sự.', formal: [], casual: [], overview: 'Tên.', examples: [example('私の名前は田中です。', 'わたしのなまえはたなかです。', 'Tên tôi là Tanaka.')], notes: ['Không nên hiểu 名前 = tên mình và お名前 = tên người khác như một quy tắc tuyệt đối.'] },
        { id: 'onamae', timingAndContext: ['Hỏi tên người đối diện.', 'Nhắc tới tên người khác một cách lịch sự.'], appropriateFor: ['Người mới gặp', 'Khách', 'Người trên'], avoid: ['Không thêm お cho tên của chính mình.'], register: 'Lịch sự.', formal: [], casual: [], overview: 'Tên — cách nói lịch sự hơn.', examples: [example('お名前は？', 'おなまえは？', 'Tên bạn là gì?')] },
        { id: 'nan-desu-ka', timingAndContext: ['Hỏi một vật hoặc một khái niệm là gì.'], appropriateFor: ['Mọi đối tượng'], avoid: ['Không dùng một mình để hỏi tên người.'], register: 'Lịch sự.', formal: [], casual: [], overview: 'Là gì?', examples: [example('これは何ですか。', 'これはなんですか。', 'Cái này là gì?')], notes: ['Trong ～は何ですか, 何 được đọc là なん.'] },
        { id: 'onamae-wa-nan-desu-ka', timingAndContext: ['Hỏi tên đầy đủ khi mới gặp.'], appropriateFor: ['Người mới gặp', 'Khách'], avoid: ['Trong hội thoại thân mật thì dài hơn cần thiết.'], register: 'Lịch sự.', formal: [], casual: ['Cách thân mật chuẩn:', 'お名前は？', 'Dùng với:', 'Người ngang hàng'], overview: 'Tên bạn là gì?', examples: [example('失礼ですが、お名前は何ですか。', 'しつれいですが、おなまえはなんですか。', 'Xin lỗi, tên bạn là gì?')] },
        { id: 'onamae-wa', timingAndContext: ['Hỏi tên ngắn gọn khi đã rõ là đang hỏi người đối diện.'], appropriateFor: ['Người mới gặp', 'Người ngang hàng'], avoid: ['Không cần thêm あなた.'], register: 'Lịch sự.', formal: ['Cách trang trọng hơn:', 'お名前は何ですか', 'Dùng với:', 'Khách', 'Người trên'], casual: [], overview: 'Còn tên bạn là...? / Tên bạn là gì?' },
        { id: 'shitsurei-desu-ga', timingAndContext: ['Mở đầu một câu hỏi có thể hơi riêng tư.'], appropriateFor: ['Người mới gặp', 'Khách', 'Người trên'], avoid: ['Không dùng để xin lỗi.', 'Không dùng để đáp lại lời chúc.'], register: 'Lịch sự.', formal: [], casual: ['Cách thân mật chuẩn:', 'すみません', 'Dùng với:', 'Người ngang hàng'], overview: 'Xin phép cho tôi hỏi...' },
        { id: 'sumimasen', timingAndContext: ['Gọi sự chú ý trước khi hỏi hoặc nhờ.', 'Xin lỗi nhẹ.'], appropriateFor: ['Mọi đối tượng'], avoid: [], register: 'Lịch sự.', formal: [], casual: [], overview: 'Xin lỗi / Cho hỏi...' },
        { id: 'mou-ichido', timingAndContext: ['Nhờ nhắc lại điều vừa nói.'], appropriateFor: ['Mọi đối tượng'], avoid: ['Không dùng khi chưa nghe gì.'], register: 'Lịch sự.', formal: [], casual: [], overview: 'Một lần nữa.', examples: [example('すみません、もう一度お願いします。', 'すみません、もういちどおねがいします。', 'Xin lỗi, làm ơn nói lại một lần nữa.')] },
        { id: 'san', timingAndContext: ['Đặt sau tên người khác khi gọi hoặc nhắc tới.'], appropriateFor: ['Người ngang hàng', 'Người mới gặp', 'Đồng nghiệp'], avoid: ['Không gắn さん vào tên của chính mình.', 'Không dùng さん với thầy cô — gọi bằng 先生.'], register: 'Lịch sự.', formal: [], casual: ['Cách thân mật chuẩn:', 'Gọi trống tên, bỏ さん', 'Dùng với:', 'Bạn bè', 'Chỉ sau khi hai bên đồng ý.'], overview: 'Cách gọi lịch sự đặt sau tên người khác.', notes: ['Thường không thêm さん vào tên của chính mình.'] },
        { id: 'desu-ne', timingAndContext: ['Xác nhận lại thông tin vừa nghe.'], appropriateFor: ['Mọi đối tượng'], avoid: ['Không dùng ～です trống để xác nhận với chính người đó.'], register: 'Lịch sự.', formal: [], casual: [], overview: 'Dùng để xác nhận thông tin vừa nghe.', notes: ['Dùng để xác nhận, không phải để hỏi lại.'] },
      ],
      dialogueGroups: [
        {
