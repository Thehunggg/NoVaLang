...
const JA_UNIT1_LESSON2_SOURCE = {
  ...
  lesson: {
    ...
    content: {
      ...
      vocabularyDetails: [
        { id: 'namae', timingAndContext: ['Nói về tên nói chung.', 'Nói tên của chính mình.'], appropriateFor: ['Mọi đối tượng'], avoid: ['Không thêm お cho tên của chính mình.'], register: 'Trung tính.', formal: [], casual: [], overview: 'Tên.', examples: [example('私の名前は田中です。', 'わたしのなまえはたなかです。', 'Tên tôi là Tanaka.')], notes: ['Không nên hiểu 名前 = tên mình và お名前 = tên người khác như một quy tắc tuyệt đối.'] },
        ...
        { id: 'mou-ichido', timingAndContext: ['Nhờ nhắc lại điều vừa nói.'], appropriateFor: ['Mọi đối tượng'], avoid: ['Không dùng khi chưa nghe gì.'], register: 'Trung tính.', formal: [], casual: [], overview: 'Một lần nữa.', examples: [example('すみません、もう一度お願いします。', 'すみません、もういちどおねがいします。', 'Xin lỗi, làm ơn nói lại một lần nữa.')] },
